...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f" <blockquote><b> ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ ᴅɪ <a href=tg://openmessage?user_id={OWNER_ID}>Luxz✮</a></blockquote"
            f" <blockquote>ᴛᴇsᴛɪᴍᴏɴɪ : <a href=https://t.me/LuxzChannel>ᴄʟɪᴄᴋ</a> </blockquote>"
        )
        await izzy_ganteng.edit(response)
